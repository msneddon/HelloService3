...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'HelloService3'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from HelloService3.HelloService3Impl import HelloService3
impl_HelloService3 = HelloService3(config)
