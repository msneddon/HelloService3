...
function HelloService3(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    this._check_job = function (job_id, _callback, _errorCallback) {
        ...
        return json_call_ajax("HelloService3._check_job", 
            [job_id], 1, _callback, _errorCallback);
    };


     this.do_something = function (_callback, _errorCallback) {
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        ...
        return json_call_ajax("HelloService3.do_something",
